...
namespace Dev\Database\Migrations;
...
class Migrator
{
    ...
    public function getRan(){
        $cData = $this->getMigrations();

        return $cData->pluck('migration')->toArray();
    }
...
//        $this->fireMigrationEvent(new MigrationsEnded);
    ...
    public function getMigrations(){
        ...
        $repo = $connection->getMapper()->getRepository('migrations');
        $data = $repo->find();
        $aData = [];
        foreach ($data as $item){
            $aData[] = $connection->getItem($item, $repo);
        }
        $cData = collect($aData);
        return $cData;
    }
...
//        }
    ...
    {
        $query = $this->getMigrations()->where('batch', $this->getLastBatchNumber());
        return $query->sortByDesc('migration')->all();
    }
...
//        $this->fireMigrationEvent(new MigrationsEnded);
    ...
    public function delete($migration)
    {
        ...
        $entity = $repo->findOne(['migration' => $migration->migration]);
...
//                $this->fireMigrationEvent(new MigrationEnded($migration, $method));
    ...
    public function resolve($file)
    {
        ...
        return new $class(app('db'), app('files'));
    }
    ...
    public function getRepository()
    {
        ...
        $connection = $this->connection;
        $repo = $connection->getMapper()->getRepository('migrations');
        $repo->getMapper()->getPlugin(Sequence::class);
        return $repo;
    }
